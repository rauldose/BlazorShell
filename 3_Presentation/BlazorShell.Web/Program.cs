...
using Autofac.Core;
using BlazorShell.Web.Components.Account;
using IdentityRevalidatingAuthenticationStateProvider = BlazorShell.Web.Components.Account.IdentityRevalidatingAuthenticationStateProvider;
